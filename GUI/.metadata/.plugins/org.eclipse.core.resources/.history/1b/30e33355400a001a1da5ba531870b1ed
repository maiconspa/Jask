...
public class Entrada extends JFrame {
	...
	public Entrada() {
		...
		btnBack.setIcon(new ImageIcon(Entrada.class.getResource("/view/arrow_back_ios.png")));
		...
		button.setIcon(new ImageIcon(Entrada.class.getResource("/view/arrow_foward_ios.png")));
		...
		label.setIcon(new ImageIcon(Entrada.class.getResource("/view/logo_bee_v1.png")));
