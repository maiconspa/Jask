...
public class Conexao {
	...
	static {
		...
		try {
			...
			JOptionPane.showMessageDialog(null, "Driver NAO encontrado...", "Problemas !", JOptionPane.WARNING_MESSAGE); // /!\ --> Verificar como fazer isso Lancar um aexce��o para a interface grafica tratar(propaga��o de exce��o"!
	...
	/**
	 * Criando um m�todo para realizar a conexao com o banco de dados.
	 */
